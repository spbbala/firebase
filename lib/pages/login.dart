...
import 'package:firebase_task/pages/home.dart';
import 'package:firebase_task/services/authServices.dart';
...
class _LoginFormState extends State<LoginForm> {
                      ...
                      if (_formKey.currentState!.validate()) {
                        ...
                        login
                            ? authServices(email, password,
                                context) /*AuthServices().signinUser(email, password, context)*/
  ...
  signup(String email, String password, BuildContext context) async {
    FirebaseAuth.instance
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('$handleError')));
    });
  }

  authServices(String email, String password, BuildContext context) async{
